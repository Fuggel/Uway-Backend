...
export const THRESHOLD = {
    ...
    GAS_STATION: {
        ...
        PRICE_DIFFERENCE_THRESHOLD: Number(process.env.GAS_STATION_PRICE_DIFFERENCE_THRESHOLD_IN_PERCENTAGE),
    },
...
export const INTERVAL = {
    RATE_LIMITER_IN_MINUTES: Number(process.env.RATE_LIMITER_INTERVAL_IN_MINUTES) * 60 * 1000,
    CACHE_REFRESH_INTERVAL_IN_MINUTES: Number(process.env.CACHE_REFRESH_INTERVAL_IN_MINUTES) * 60 * 1000,
    CLEAR_WARNING_EVENTS_INTERVAL_IN_SECONDS: Number(process.env.CLEAR_WARNING_EVENTS_INTERVAL_IN_SECONDS) * 1000,
};
